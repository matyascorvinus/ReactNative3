  ...
  render() {
    return (
      <View style={styleEmpire.container}>
          ...
          <Image style={{width: 200, height: 200}}  source = {require ('/StarWars_Football_Matches_Empire_UI/800px-Flag_of_the_First_Galactic_Empire.svg.png')}/>
          ...
          <View style = {styleEmpire.bigMatch}> 
              <View style = {styleEmpire.match} >
                    ...
                    <View style = {styleEmpire.teams} >
                      ...
                      <Image style= {{width:20, height:20}} source = {require ('/StarWars_Football_Matches_Empire_UI/240px-Emblem_of_the_First_Galactic_Empire.svg.png')}/>
                      
                      <Image style= {{width:20, height:20}} source = {require ('/StarWars_Football_Matches_Empire_UI/Rebel_Alliance_logo.svg.png')}/>
           ...
           <View style = {styleEmpire.bigMatch}> 
                    <View style = {styleEmpire.match} >
                      ...
                      <View style = {styleEmpire.teams} >
                        ...
                        <Image style= {{width:20, height:20}} source = {require ('/StarWars_Football_Matches_Empire_UI/darth_vader_PNG14.png')}/>
                        
                        <Image style= {{width:20, height:20}} source = {require ('/StarWars_Football_Matches_Empire_UI/Darth_Sidious_Render.png')}/>
